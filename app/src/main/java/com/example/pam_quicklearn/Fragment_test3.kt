...
class Fragment_test3(val con: Context, val state:PlayerState): Fragment() {
    ...
    override fun onCreateView(
        ...
        val view: View = inflater.inflate(R.layout.fragment_test3, container, false)
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        playerHolder = PlayerHolder(con, exoplayer_fragmenttest3, state)
        ...
        playerHolder.playerState.uristringVideo =  "assets:///Hamilton-Upside_Trim.mp4"
